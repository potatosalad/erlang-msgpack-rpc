...
choose_type_jsx() ->
    oneof([positive_fixnum(), negative_fixnum(),
           ...
           nil(), boolean(),
           fix_raw(), %raw16(), raw32(),
           fix_array_jsx(), %array16_jsx(), array32_jsx(),
           fix_map_jsx(), %map16_jsx(), map32_jsx(),
           mapempty_jsx()
          ]).
...
choose_type_jiffy() ->
    oneof([positive_fixnum(), negative_fixnum(),
           ...
           nil(), boolean(),
           fix_raw(), %raw16(), raw32(),
           fix_array_jiffy(), %array16_jiffy(), array32_jiffy(),
           fix_map_jiffy(), %map16_jiffy(), map32_jiffy(),
           mapempty_jiffy()
          ]).
